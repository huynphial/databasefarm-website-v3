        ...
        <div className="flex items-start gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="font-bold text-slate-900 text-base">{t('account.title')}</h2>
              <span
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-2xs space-y-5">
            ...
            <div className="space-y-4 text-xs">
              <div>
                <label className="block text-slate-500 font-medium mb-1">{t('account.username')}</label>
              ...
              <div>
                <label className="block text-slate-500 font-medium mb-1">{t('account.role')}</label>
              ...
              <div>
                <label className="block text-slate-500 font-medium mb-1">{t('account.accountState')}</label>
                <div className="px-3 py-2 bg-emerald-50/60 border border-emerald-200/80 rounded-lg font-bold text-emerald-800 flex items-center gap-2">
                  ...
                  <span>{t('account.activeUnlocked')}</span>
                </div>
              </div>
                ...
                >
                  {isSubmittingSelf ? (
                    <>
                      ...
                      <span>{t('account.updatingPassword')}</span>
                    </>
                  ) : (
                    <>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-2xs space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-base">{t('account.userDirectoryTitle')}</h3>
                <p className="text-slate-500 text-xs">
                  {t('account.userDirectorySub')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              >
                ...
                <span>{t('account.createNewAccount')}</span>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-slate-50 border border-slate-200/80 rounded-lg p-3 flex items-center justify-between">
              <div>
                <div className="text-[10px] uppercase font-bold text-slate-400">{t('account.totalAccounts')}</div>
            ...
            <div className="bg-emerald-50/50 border border-emerald-200/70 rounded-lg p-3 flex items-center justify-between">
              <div>
                <div className="text-[10px] uppercase font-bold text-emerald-600">{t('account.activeUnlockedChip')}</div>
            ...
            <div className="bg-rose-50/50 border border-rose-200/70 rounded-lg p-3 flex items-center justify-between">
              <div>
                <div className="text-[10px] uppercase font-bold text-rose-600">{t('account.lockedOutChip')}</div>
            ...
            <div className="bg-indigo-50/50 border border-indigo-200/70 rounded-lg p-3 flex items-center justify-between">
              <div>
                <div className="text-[10px] uppercase font-bold text-indigo-600">{t('account.administratorsChip')}</div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-50/70 p-3 rounded-lg border border-slate-200">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <div className="flex items-center gap-1.5 text-xs text-slate-500 shrink-0">
                ...
                <span className="font-semibold text-[11px]">{t('account.roleFilterLabel')}</span>
              </div>
              <select
                value={roleFilter}
              ...
              >
                <option value="ALL">{t('account.allRoles')}</option>
                <option value="ADMIN">{t('account.adminOnly')}</option>
                <option value="VIEWER">{t('account.viewerOnly')}</option>
              </select>

              <div className="flex items-center gap-1.5 text-xs text-slate-500 shrink-0 ml-2">
                <span className="font-semibold text-[11px]">{t('account.statusFilterLabel')}</span>
              </div>
              <select
                value={statusFilter}
              ...
              >
                ...
                <option value="ACTIVE">{t('account.activeStatus')}</option>
                <option value="LOCKED">{t('account.lockedStatus')}</option>
              </select>
            </div>
          </div>
