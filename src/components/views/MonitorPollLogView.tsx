    ...
    <div className="p-6 sm:p-8 flex-1 flex flex-col gap-6 overflow-y-auto bg-slate-50/50">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold rounded-lg bg-white border border-slate-300 text-slate-700 hover:bg-slate-100 transition-colors shadow-2xs cursor-pointer disabled:opacity-60"
        >
          <RefreshCw className={cn('w-3.5 h-3.5', isRefreshing && 'animate-spin text-indigo-600')} />
          <span>{isRefreshing ? 'Refreshing...' : 'Refresh Poll State'}</span>
        </button>
      </div>
      ...
      {/* MAIN FILTER CONTROLS BAR (Engine, Target Database, Time Window like Analytics Database) */}
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-xs space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                Filter poll execution logs by engine, target database instance, and sliding time window.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3.5">
          ...
          <div className="md:col-span-3 space-y-1.5">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all cursor-pointer appearance-none pr-8"
              >
          ...
          <div className="md:col-span-4 space-y-1.5" ref={dbDropdownRef}>
            <label className="flex items-center gap-1.5 text-[11px] font-bold text-slate-600 uppercase tracking-wider">
            ...
            <div className="relative">
              <button
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs text-left font-semibold text-slate-800 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all flex items-center justify-between cursor-pointer"
              >
          ...
          <div className="md:col-span-5 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="relative">
                <span className="absolute left-2.5 top-2 text-[10px] font-bold text-slate-400 uppercase pointer-events-none">
                  From:
                </span>
                <input
                  type="datetime-local"
                  ...
                  className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-12 pr-2 py-1.5 text-xs font-mono text-slate-800 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all cursor-pointer"
                />
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-8 pr-2 py-1.5 text-xs font-mono text-slate-800 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all cursor-pointer"
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-100 text-xs">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-slate-700 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-full">
              ...
              <span className="text-[9px] text-slate-400 font-normal ml-0.5">(Queue unfiltered by time)</span>
            </span>
          </div>
