...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  // Hover Tooltips data resolution (only enabled databases in down list)
  ...
  const filteredDbStatuses = dbStatuses.filter((db) => {
    ...
    if (severityFilter === 'DOWN') {
      const isDown = db.derivedStatus === 'DOWN' || dbAlerts.some((a) => a.alertLevel === 'DOWN' || a.alertLevel === 'CRITICAL');
      return isDown && isDbEnabled(db);
    }
