...
const NOTIFICATION_TOKENS = [
  ...
  { token: 'D_DATABASEGROUP_NAME', label: 'DB Group Name', desc: 'Target database group display name' },
  ...
  { token: 'D_METRICTEMPLATE_NAME', label: 'Metric Template', desc: 'Evaluated metric template name' },
