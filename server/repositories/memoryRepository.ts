  ...
  private groups: GroupEntity[] = [
    {
      ...
      notificationMappings: [
        { notificationMethodId: 'meth-email-01', senderIds: 'dba-oncall@company.internal' },
    ...
    },
    {
      ...
      notificationMappings: [
        { notificationMethodId: 'meth-email-01', senderIds: 'bi-infra@company.internal' },
      ],
      createdAt: new Date(Date.now() - 20 * 86400000).toISOString(),
      updatedAt: new Date(Date.now() - 1 * 86400000).toISOString(),
    },
  ...
  private databases: DatabaseEntity[] = [
    {
      id: 'db-01',
      name: 'ERP_PROD_ORA',
      databaseSystem: 'ERP Enterprise Core',
      dbType: 'ORACLE',
      host: '10.0.10.45',
      port: 1521,
      ...
      username: 'dbmon_user',
      password: '',
      passwordEncrypted: 'enc:7911502db3befe0f664f7ecf2a70b498:7a1ae027ca9b35348eaa2ce9328db52a14bd3d6782b971d963513e1d59b9aabf',
    ...
    },
    {
      id: 'db-02',
      name: 'PAYMENT_API_PG',
      databaseSystem: 'Payment Gateway',
      dbType: 'POSTGRES',
      host: '10.0.12.88',
      port: 5432,
    ...
    },
    {
      id: 'db-04',
      name: 'DW_REPORTS_MS',
      databaseSystem: 'BI & Analytics Warehouse',
      dbType: 'MSSQL',
      host: '10.0.30.55',
      port: 1433,
      tags: ['LAB', 'ANALYTICS'],
    ...
    },
    {
      ...
      databaseSystem: 'Inventory Management',
      dbType: 'MYSQL',
      host: '10.0.40.72',
      port: 3306,
      tags: ['DEV', 'LAB'],
    ...
    if (tplData.id) {
      ...
      if (idx !== -1) {
        this.templates[idx] = {
          ...
          targetDbType,
          databaseEngineId,
          alertHourMode: tplData.alertHourMode !== undefined ? tplData.alertHourMode : (this.templates[idx].alertHourMode || 'ALL_DAY'),
          alertHourStart: tplData.alertHourStart !== undefined ? tplData.alertHourStart : (this.templates[idx].alertHourStart || '07:30'),
          alertHourEnd: tplData.alertHourEnd !== undefined ? tplData.alertHourEnd : (this.templates[idx].alertHourEnd || '17:00'),
