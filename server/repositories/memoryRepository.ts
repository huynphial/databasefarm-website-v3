...
FROM pg_tablespace`,
  ...
  private rawMeasurements: RawMeasurementEntity[] = [
    ...
    },
    {
      ...
      valueType: 'NUMBER',
      thresholdOperator: '>=',
      triggeredThreshold: 'Crit: 500 (>=)',
      cycle: 1,
      status: 'CRITICAL' as any,
      measuredAt: new Date(Date.now() - 3.5 * 60000).toISOString(),
    },
    {
      id: 'raw-02c',
      dbId: 'db-01',
      ...
      valueType: 'NUMBER',
      thresholdOperator: '>=',
      triggeredThreshold: 'Fatal: 99.0 (>=)',
      cycle: 1,
      status: 'FATAL' as any,
      measuredAt: new Date(Date.now() - 1 * 60000).toISOString(),
    },
    {
      id: 'raw-03',
      dbId: 'db-02',
