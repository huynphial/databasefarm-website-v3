  ...
  async getAlertNotificationLogs(): Promise<AlertNotificationLogEntity[]> {
    ...
    return [
      ...
      },
      {
        ...
        detailResponse: 'HTTP 200 ok (Corporate SMTP)',
        latencyMs: 210,
      },
      {
        id: 'notif-log-05',
      ...
      },
      {
        ...
        senderIds: '-1001234567890',
        status: 'FAILED',
        errorMessage: 'HTTP 429: Rate limit exceeded on Telegram provider',
        payloadSummary: 'HIGH: PAYMENT_API_PG connection saturation > 85%',
        messageAlert: 'HIGH: PAYMENT_API_PG connection saturation > 85%',
        detailResponse: 'HTTP 429 Too Many Requests: Rate limit exceeded on Telegram provider',
        latencyMs: 850,
      }
    ];
  }
