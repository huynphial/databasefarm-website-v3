  ...
  const alertNotificationLogsData = [
    {
      ...
      lockedAt: new Date(Date.now() - 18 * 60000 - 5000),
      lockedBy: 'worker-node-01',
      finishedAt: new Date(Date.now() - 18 * 60000),
    },
    {
      alertId: 'alt-01',
      alertLevel: 'CRITICAL',
      ...
      lockedAt: new Date(Date.now() - 18 * 60000),
      lockedBy: 'worker-node-02',
      finishedAt: new Date(Date.now() - 18 * 60000 + 1200),
    },
    {
      alertId: 'alt-02',
      alertLevel: 'CRITICAL',
      ...
      lockedAt: new Date(Date.now() - 35 * 60000 - 3000),
      lockedBy: 'worker-node-01',
      finishedAt: new Date(Date.now() - 35 * 60000),
    },
    {
      alertId: 'alt-03',
      alertLevel: 'HIGH',
      ...
      lockedAt: new Date(Date.now() - 75 * 60000 - 2000),
      lockedBy: 'worker-node-03',
      finishedAt: new Date(Date.now() - 75 * 60000),
    },
    {
      alertId: 'alt-04',
      alertLevel: 'WARN',
      dbId: dbMsId,
      dbName: 'DWH_REPORT_MS',
      metricId: metPageLifeId,
      metricName: 'Page Life Expectancy (PLE)',
      objectName: 'GLOBAL',
      attributeName: 'ple_seconds',
      value: '240s',
      messageAlert: 'WARN: DWH_REPORT_MS Buffer Manager PLE dropped to 240s',
      senderIdList: 'dba-team@company.internal',
      dispatcherId: 'meth-email-01',
      dispatcherName: 'Corporate SMTP Dispatcher',
      dispatcherType: 'EMAIL',
      ...
      lockedAt: new Date(Date.now() - 120 * 60000 - 1000),
      lockedBy: 'worker-node-02',
      finishedAt: new Date(Date.now() - 120 * 60000),
    },
    {
      alertId: 'althist-01',
      alertLevel: 'HIGH',
      ...
      lockedAt: new Date(Date.now() - 5 * 3600000 - 5000),
      lockedBy: 'worker-node-01',
      finishedAt: new Date(Date.now() - 5 * 3600000),
    },
  ];
